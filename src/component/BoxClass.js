...
export default class BoxClass extends Component {
  ...
  constructor(){
    super();
    this.result=""
    this.defaultImg = "https://www.supercoloring.com/sites/default/files/styles/coloring_medium/public/cif/2022/01/1471-red-question-mark-emoji-coloring-page.png"
  }

  getResult = () => {
    if( this.props.title === "Computer" && this.props.result !== "Tie" && this.props.result !== "") this.result = this.props.result === "Win" ? "Lose" : "Win"
