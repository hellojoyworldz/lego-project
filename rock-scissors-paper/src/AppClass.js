    ...
    return (
      ...
      <section>
        ...
        <div className="play-wrapper">
          <button className="play-btn" onClick={() => this.play("scissors")}>✌🏻<span className="readonly">scissors</span></button>
          <button className="play-btn" onClick={() => this.play("rock")}>✊🏻<span className="readonly">rock</span></button>
          <button className="play-btn" onClick={() => this.play("paper")}>🖐🏻<span className="readonly">paper</span></button>
        </div>

        <div className="select-wrapper">
          <BoxClass title="You" item={this.state.serSelect} result={this.state.result} />
